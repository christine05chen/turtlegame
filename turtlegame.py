...
while races > 0: 
    ...
    color=["pink", "red", "orange", "yellow", "green", "aquamarine", "light blue", "cyan", "blue", "lavender", "purple", "black"]
...
if turtle1score > turtle2score:
    turtleref.write("Turtle 1 Won", align="center", font=("Arial", 20))
elif turtle2score > turtle1score:
    turtleref.write("Turtle 2 Won", align="center", font=("Arial", 20))
elif turtle1score == turtle2score:
    turtleref.write("Tie!", align="center", font=("Arial", 20))
